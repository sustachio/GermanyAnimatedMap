...
**Software for the ESP32**: All software loaded on the ESP32 and configuration needed to do so with PlatformIO can be found in the `PlatformIOCode` folder.

**Webapp for categorization**: Unfortunately none of the background images will load anymore as the Canva links I was using to host them have expired, but the rest of the app is still funcitonal. You can also run it online [here](https://germanyapatagorizer.oneapp.dev/).
